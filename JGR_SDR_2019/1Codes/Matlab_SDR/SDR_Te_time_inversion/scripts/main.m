...
%    n_time=TIME(i_time)    %print out where it goes to      
  ...
  %          &&(misfit(i_time,(num_trial-1))<misfit(i_time,(num_trial-2))))
        ...
        SDR_misfit_plot(particle_x,particle_y,particle_y_semi_analytic,i_time,num_trial,n_time*30,Te_guess,misfit(i_time,num_trial));
    ...
    i_time = i_time + 1;
    save('PDF_6_SDR3_20170502_dTe5_alpha2_tolerance20000_particles_4.mat')
end
