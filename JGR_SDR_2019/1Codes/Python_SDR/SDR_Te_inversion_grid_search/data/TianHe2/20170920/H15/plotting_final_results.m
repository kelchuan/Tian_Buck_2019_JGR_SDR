...
plot(TIME*20,TE/1000,'ko','markersize',12,'linewidth',1.6)
hold on
%plot(TIME(1:77),TE/1000,'b-.','linewidth',2)
plot(TIME*20,TE/1000,'b-.','linewidth',2)
grid on;
...
[hAx,hLine1,hLine2] = plotyy(TIME*20,TE/1000,TIME*20,sqrt(MISFIT))
hLine2.LineStyle = '-.';
ylabel(hAx(2),'Misfit [m]','Fontsize',22') % right y-axis
axis([(min(TIME*20)-120) (max(TIME*20)+120) (min(TE/1000)-1.0) (max(TE/1000)+0.6)]);
